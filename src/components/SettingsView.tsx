...
import { Settings, Trash2, Plus, DollarSign, Wallet, ChevronUp, ChevronDown, Sparkles } from 'lucide-react';
...
export const SettingsView = ({
    ...
    return (
        <div className="glass-card stagger-reveal" style={{ padding: 'clamp(1rem, 4vw, 2.5rem)', background: 'rgba(255,255,255,0.95)' }}>
